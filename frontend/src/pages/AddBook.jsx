...
const AddBook = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validate ISBN
    if (formData.isbn.length !== 13 || !/^\d{13}$/.test(formData.isbn)) {
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-6">
            <div className="md:col-span-7 flex flex-col">
              <label className="text-sm font-semibold text-gray-700 mb-2">Title <span className="text-red-500">*</span></label>
              <input 
                type="text" 
                name="title"
            ...
            <div className="md:col-span-5 flex flex-col">
              <label className="text-sm font-semibold text-gray-700 mb-2">Author <span className="text-red-500">*</span></label>
              <input 
                type="text" 
                name="author"
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-6">
            <div className="md:col-span-4 flex flex-col">
              <label className="text-sm font-semibold text-gray-700 mb-2">Isbn <span className="text-red-500">*</span></label>
              <input 
                type="text" 
                name="isbn"
                value={formData.isbn}
            ...
            <div className="md:col-span-4 flex flex-col">
              <label className="text-sm font-semibold text-gray-700 mb-2">Price <span className="text-red-500">*</span></label>
              <input 
                type="number" 
                name="price"
          ...
          <div className="flex flex-col mb-6">
            <label className="text-sm font-semibold text-gray-700 mb-2">About the book (short description) <span className="text-red-500">*</span></label>
